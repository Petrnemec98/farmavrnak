 ...
 <div class="overlay-background">
    <section class="overlay-box">
      <div class="overlay-box-close">
        <a class="overlay-close" data-id="minutky" onclick="offOverlay(this)">
        </a>
      </div>
...
<div id="peceni" class="overlay-noactive">
 <div class="overlay-background">
    <section class="overlay-box">
      <div class="overlay-box-close">
        <a class="overlay-close" data-id="peceni" onclick="offOverlay(this)">
        </a>
      </div>
      <div class="box-h1-prepered">
        <div class="box-h2-title">
      ...
      <div class="overlay-box-content">
        ...
        <article>
          ...
          <a href="#podkrci" data-id="peceni" onclick="offOverlay(this)">
            <span>Podkrčí</span>
          </a>
          <a href="#karabacek" data-id="peceni" onclick="offOverlay(this)">
            <span>Karabáček</span>
          </a>
          <a href="#nizky-rostenec" data-id="peceni" onclick="offOverlay(this)">
            <span>Nízký roštěnec</span>
          </a>
          <a href="#plecovy-platek" data-id="peceni" onclick="offOverlay(this)">
...
<div id="duseni" class="overlay-noactive">
 <div class="overlay-background">
    <section class="overlay-box">
      <div class="overlay-box-close">
        <a class="overlay-close" data-id="duseni" onclick="offOverlay(this)">
        </a>
      </div>
      <div class="box-h1-prepered">
        <div class="box-h2-title">
      ...
      <div class="overlay-box-content">
        ...
        <article>
          ...
          <a href="#klizka" data-id="duseni" onclick="offOverlay(this)">
            <span>Zadní kližka</span>
          </a>
          <a href="#karabacek" data-id="duseni" onclick="offOverlay(this)">
            <span>Karabáček</span>
          </a>
          <a href="#klizka" data-id="duseni" onclick="offOverlay(this)">
            <span>Přední kližka</span>
          </a>
           <a href="#plecovy-platek" data-id="duseni" onclick="offOverlay(this)">
            <span>Plátek Lopatkový</span>
          </a>
...
<div id="mleti" class="overlay-noactive">
 <div class="overlay-background">
    <section class="overlay-box">
      <div class="overlay-box-close">
        <a class="overlay-close" data-id="mleti" onclick="offOverlay(this)">
        </a>
      </div>
      <div class="box-h1-prepered">
        <div class="box-h2-title">
      ...
      <div class="overlay-box-content">
        <article>
          ...
          <a href="#plecovy-platek" data-id="mleti" onclick="offOverlay(this)">
            <span>Plátek lopatkový</span>
          </a>
        </article>
      </div>
...
<div id="tatarak" class="overlay-noactive">
 <div class="overlay-background">
    <section class="overlay-box">
      <div class="overlay-box-close">
        <a class="overlay-close" data-id="tatarak" onclick="offOverlay(this)">
        </a>
      </div>
      <div class="box-h1-prepered">
        <div class="box-h2-title">
...
<div id="med-kvetovy" class="overlay-noactive">
 <div class="overlay-background">
    <section class="overlay-box">
      ...
      <a class="med-button" href="pripravujeme"><div class="meat-info-icon e-shop-icon"></div>
